...
modes, focus-follows-mouse, true scrollback wipe, pin/toggle-last tabs, broadcast input,
aggregated tab progress, notify-on-done/-activity, `[hotkeys]` remapping, and settings sync
to your own git repo (Push/Pull with your existing credentials, optional autosync).
