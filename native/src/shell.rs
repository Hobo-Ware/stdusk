...
_stdusk_preexec() { print -n '\e]133;C\a' }
_stdusk_precmd()  { local ec=$?; print -n "\e]133;D;${ec}\a\e]133;A\a" }
...
__stdusk_prompt() { local ec=$?; printf '\033]133;D;%d\007\033]133;A\007' "$ec"; }
